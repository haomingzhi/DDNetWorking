#
#  Be sure to run `pod spec lint DDNetWorking.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/haomingzhi/DDNetWorking.git"
  ...
  s.author             = { "haomingzhi" => "736569747@qq.com" }
  ...
  s.source       = { :git => "https://github.com/haomingzhi/DDNetWorking.git", :tag => "#{s.version}" }
